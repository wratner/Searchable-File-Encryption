...
public class FileHash {
	...
	FileHash(String targetDir, String key) {
		...
		/*
		 * System.out.println(fileList); System.out.println(dirList);
		 */
		/*
		 * try { Indexer.mapToIndexFile(Indexer.indexMessages(null, dirList,
		 * fileList, "D:\\temp_CS463\\seperators.txt",
		 * "D:\\temp_CS463\\stopwords.txt"), dirLoc + "index.txt"); } catch
